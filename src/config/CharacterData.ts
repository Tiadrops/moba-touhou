  ...
  [CharacterType.REIMU]: {
    ...
    skills: {
      Q: {
        id: 'reimu_q',
        name: '妖怪バスター',
        description: '前方に札を投げる。命中でCD75%解消、スロウ付与、針巫女スタック獲得',
        cooldown: 4000,
      },
      W: {
        id: 'reimu_w',
        name: '封魔針',
        description: '前方に針を投げ1秒スタン。Break成功時E CD50%解消+追加ダメージ',
        cooldown: 6000,
      },
      E: {
        id: 'reimu_e',
        name: '昇天蹴',
        description: '3mダッシュ。ダッシュ中90%ダメージカット',
        cooldown: 12000,
      },
      R: {
        id: 'reimu_r',
        name: '夢想天生',
        description: '2秒間、周囲10m四方に継続ダメージを与える',
        cooldown: 60000,
      },
    },
  },
